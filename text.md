...
Platforms cannot be obliged to implement an automated notification-and-stay-down procedure and such a procedure can only be an admissible reaction to content that violates the essence of fundamental rights and need not be assessed according to a proportionality test (e.g. child pornography). Only if such content can be detected by automated systems with a very high probability can the system be used in practice. The technical systems used for automated deletion must follow an open peer-reviewed methodology, be periodically reviewed by an independent body, and require annual transparency reports on the success rate of the systems. The attempted publication of such content constitutes a serious criminal offence and therefore platforms must inform authorities in all cases where the upload was prevented. A public authority with judicial oversight has to determine for all individual content whether it meets the requirement of this category. Affected users have the right to a redress mechanism and judicial review against the automatic deletion of their content.
...
## `MUST` Social Media Oversight Council
...
In order to foster effective law enforcement all account holders on social media platforms should be obliged to register with their real identity with social media platforms. The platform is obliged to hand over the identitiy information for the account of any posting after having received a request from a law enforcement agency or a private individual that is pursuing defamatory cases or copyright claims.
